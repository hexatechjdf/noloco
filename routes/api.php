...
Route::post('webhook/update/contact/by/deal/status', [WebhookController::class, 'updateContactByDeal'])->name('update.contact.by.deal.status')->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
Route::post('webhook/credit/app/handle', [WebhookController::class, 'creditAppHandle'])->name('credit.app.management')->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
Route::post('webhook/store/dealers/data', [WebhookController::class, 'storeDealer'])->name('store.dealers')->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
